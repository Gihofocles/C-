...
using namespace std;
void tablacostos(){
    string tablacostos[6][3]={"No.Vuelo  ","\tDestino  ","\tCosto  ","1256  ","\t\tCancun  ","\t4285.25  ","2565  ","\t\tMonterrey  ","\t3859.36  ","1278  ","\t\tGuadalajara  ","\t2156.36  ","4585  ","\t\tChihuahua  ","\t3258.00  ","3698  ","\t\tVeracruz  ","\t1256.25  ",};
    for(int i=0;i<6;i++){
        for(int g=0;g<3;g++){
            cout<<tablacostos[i][g];
        }
        cout<<endl;
    }
}
